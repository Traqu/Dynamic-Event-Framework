...
class CfgVehicles
{
    ...
    //* StaritingPoints.
    class DEF__Starting_Point_NO_DISPLAY_DE: DEF_DynamicEventObject{}; //? This one proved to be useful so I am adding it; has no script to it so will not be displayd on map.

    class DEF__Starting_Point_Base_DE: DEF_DynamicEventObject
    {
    ...
    //* GenericObjects.
    class DEF_Ammoboxes_Big_DE: DEF_DynamicEventObject
    {
        model="DZ\structures_bliss\underground\storage\proxy\ammoboxes_big.p3d";
    };

    class DEF_Ammoboxes_Single_DE: DEF_DynamicEventObject
    {
        model="DZ\structures_bliss\underground\storage\proxy\ammoboxes_single.p3d";
    };

    class DEF_Ammoboxes_Stacked_DE: DEF_DynamicEventObject
    {
        model="DZ\structures_bliss\underground\storage\proxy\ammoboxes_stacked.p3d";
    };

    class DEF_Animal_Guts_DE: DEF_DynamicEventObject
    {
        model="DZ\gear\food\animal_guts.p3d";
    };

    class DEF_Concrete_Panel_DE: DEF_DynamicEventObject
    {
        model="DZ\structures\roads\panels\panel_concrete_1.p3d";
    };

    class DEF_Concrete_Panel_Damaged_DE: DEF_DynamicEventObject
    {
        model="DZ\structures\roads\panels\panel_concrete_dam.p3d";
    };

    class DEF_Concrete_Panel_2_DE: DEF_DynamicEventObject
    {
        model="DZ\structures\roads\panels\panel_concrete_2.p3d";
    };

    class DEF_Concrete_Panels_DE: DEF_DynamicEventObject
    {
        model="DZ\structures\roads\panels\panels_concrete.p3d";
    };

    class DEF_Concrete_Path_DE: DEF_DynamicEventObject
    {
        model="DZ\structures\roads\panels\path_panels.p3d";
    };

    class DEF_Concrete_Path_Damaged_DE: DEF_DynamicEventObject
    {
...
//? INDUSTRIAL LOOT ↓
    ...
    class DEF_StaticObj_Wreck_Bulldozer_INDUSTRIAL_DE: DEF_DynamicEventObject
    {
        model="DZ\structures\Wrecks\Vehicles\Wreck_Bulldozer.p3d";
    };

    class DEF_StaticObj_Wreck_Digger_INDUSTRIAL_DE: DEF_DynamicEventObject
    {
        model="DZ\structures\Wrecks\Vehicles\Wreck_Digger.p3d";
    };

    class DEF_StaticObj_Wreck_Trailer_Flat_INDUSTRIAL_DE: DEF_DynamicEventObject
    {
        model="DZ\structures\Wrecks\Vehicles\Wreck_Trailer_Flat.p3d";
    };

    class DEF_Land_Wreck_Mining_Excavator_INDUSTRIAL_DE: DEF_DynamicEventObject
    {
        model="\DZ\structures_bliss\Wrecks\Vehicles\Wreck_Mining_Excavator.p3d";
    };

    class DEF_Land_Wreck_Mining_HaulTruck_INDUSTRIAL_DE: DEF_DynamicEventObject
    {
...
//? INDUSTRIAL LOOT ↑
    ...
    class DEF_Land_Ship_Big_FrontA_DE : DEF_DynamicEventObject
    {
        model="\DZ\structures\Wrecks\Ships\Ship_Big_FrontA.p3d";
    };

    class DEF_Land_Ship_Big_FrontB_DE : DEF_DynamicEventObject
    {
        model="\DZ\structures\Wrecks\Ships\Ship_Big_FrontB.p3d";
    };

    class DEF_Land_Ship_Big_BackA_DE : DEF_DynamicEventObject
    {
        model="\DZ\structures\Wrecks\Ships\Ship_Big_BackA.p3d";
    };

    class DEF_Land_Ship_Big_BackB_DE : DEF_DynamicEventObject
    {
        model="\DZ\structures\Wrecks\Ships\Ship_Big_BackB.p3d";
    };

    class DEF_Land_Ship_Big_Castle_DE : DEF_DynamicEventObject
    {
        model="\DZ\structures\Wrecks\Ships\Ship_Big_Castle.p3d";
    };

    class DEF_StaticObj_Wreck_Ship_Medium_Front_DE : DEF_DynamicEventObject
    {
        model="DZ\structures\Wrecks\Ships\Ship_Medium_Front.p3d";
    };

    class DEF_StaticObj_Wreck_Ship_Medium_Back_DE : DEF_DynamicEventObject
    {
    ...
    class DEF_StaticObj_Wreck_Ship_Big_Lifeboat_DE : DEF_DynamicEventObject
    {
        model="DZ\structures\Wrecks\Ships\Ship_Big_Lifeboat.p3d";
    };

    class DEF_Land_Boat_Small7_DE : DEF_DynamicEventObject
    {
        model="DZ\structures_sakhal\wrecks\Boat_Small7.p3d";
    };

    class DEF_Land_Boat_Small8_Blue_DE : DEF_DynamicEventObject
    {
        model="DZ\structures_sakhal\wrecks\Boat_Small8_Blue.p3d";
    };

    class DEF_Land_Boat_Small8_Red_DE : DEF_DynamicEventObject
    {
    ...
    class DEF_Land_Boat_Small10_Blue_DE : DEF_DynamicEventObject
    {
        model="DZ\structures_sakhal\wrecks\Boat_Small10_Blue.p3d";
    };

    class DEF_Land_Boat_Small10_Red_DE : DEF_DynamicEventObject
    {
        model="DZ\structures_sakhal\wrecks\Boat_Small10_Blue.p3d";
    };

    class DEF_StaticObj_Transmitter_Small2_DE : DEF_DynamicEventObject
    {
        model="DZ\structures_bliss\Specific\Towers\Transmitter_Small2.p3d";
    };

    class DEF_Land_Mil_Antena_K7_DE : DEF_DynamicEventObject
    {
        model="DZ\structures_sakhal\military\radar\Mil_Antena_K7.p3d";
    };

    //* TRANSMITTERS
    class DEF_RADIOWAVE_TRANSMITTER_StaticObj_Transmitter_Small2_DE : DEF_StaticObj_Transmitter_Small2_DE{};
    class DEF_RADIOWAVE_TRANSMITTER_Land_Mil_Antena_K7_DE : DEF_Land_Mil_Antena_K7_DE{};

    //* Particles.
    //? Fires.
    class DEF_PARTICLE_BONFIRE_FIRE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_CAMP_SMALL_FIRE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_CAMP_NORMAL_FIRE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_CAMP_STOVE_FIRE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_HOUSE_SMALL_FIRE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_HOUSE_NORMAL_FIRE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_BARREL_SMALL_FIRE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_BARREL_NORMAL_FIRE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_OVEN_SMALL_FIRE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_OVEN_NORMAL_FIRE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_TORCH_T1_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_TORCH_T2_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_TORCH_T3_DE: DEF_DynamicEventObject{};
    //? Environmental.
    class DEF_PARTICLE_SPOOKY_MIST_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_CONTAMINATED_AREA_GAS_BIGASS_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_ENV_SWARMING_FLIES_DE: DEF_DynamicEventObject{};
    //? Smokes.
    class DEF_PARTICLE_BONFIRE_SMOKE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_GRENADE_M18_BLACK_LOOP_SMOKE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_GRENADE_M18_GREEN_LOOP_SMOKE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_GRENADE_M18_PURPLE_LOOP_SMOKE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_GRENADE_M18_RED_LOOP_SMOKE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_GRENADE_M18_WHITE_LOOP_SMOKE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_GRENADE_M18_YELLOW_LOOP_SMOKE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_GRENADE_RDG2_BLACK_LOOP_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_GRENADE_RDG2_WHITE_LOOP_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_HATCHBACK_COOLANT_OVERHEATED_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_HATCHBACK_ENGINE_OVERHEATED_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_POWER_GENERATOR_SMOKE_DE: DEF_DynamicEventObject{};
    class DEF_PARTICLE_ROADFLARE_BURNING_SMOKE_DE: DEF_DynamicEventObject{};
...
class CfgSoundsets
{
    ...
    {
        soundShaders[] = {"DEF_Shipwreck_SoundShader"};
    };
    ...
    {
        soundShaders[] = {"DEF_BoatWaves_SoundShader"};
		rangeCurve="Smooth1Curve";
    };

    class DEF_BoatCreakingDeck_SoundSet: WaterStream_SoundSet
    {
        soundShaders[] = {"DEF_BoatCreakingDeck_SoundShader"};
		rangeCurve="Smooth1Curve";
    };

	class DEF_RadioNoise_SoundSet_2000
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_2000"};
	};

	class DEF_RadioNoise_SoundSet_1200
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_1200"};
	};

	class DEF_RadioNoise_SoundSet_1000
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_1000"};
	};

	class DEF_RadioNoise_SoundSet_900
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_900"};
	};

	class DEF_RadioNoise_SoundSet_800
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_800"};
	};

	class DEF_RadioNoise_SoundSet_700
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_700"};
	};

	class DEF_RadioNoise_SoundSet_600
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_600"};
	};

	class DEF_RadioNoise_SoundSet_500
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_500"};
	};

	class DEF_RadioNoise_SoundSet_400
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_400"};
	};

	class DEF_RadioNoise_SoundSet_300
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_300"};
	};

	class DEF_RadioNoise_SoundSet_200
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_200"};
	};

	class DEF_RadioNoise_SoundSet_100
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_100"};
	};

	class DEF_RadioNoise_SoundSet_50
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_50"};
	};

	class DEF_RadioNoise_SoundSet_25
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_25"};
	};

	class DEF_RadioNoise_SoundSet_10
	{
		soundShaders[] = {"DEF_RadioNoise_SoundShader_10"};
	};
};
...
{
	class DEF_Dummy_Silent_SoundShader
	{
    ...
    class DEF_BoatCreakingDeck_SoundShader
	{
	...
	class DEF_RadioNoise_SoundShader_2000
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 0.025;
		rangeCurve[] = {{0,1},{5,0.7}};
	};

	class DEF_RadioNoise_SoundShader_1200
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 0.05;
	...
	class DEF_RadioNoise_SoundShader_1000
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 0.1;
	...
	class DEF_RadioNoise_SoundShader_900
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 0.2;
	...
	class DEF_RadioNoise_SoundShader_800
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 0.4;
	...
	class DEF_RadioNoise_SoundShader_700
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 0.6;
	...
	class DEF_RadioNoise_SoundShader_600
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 0.8;
	...
	class DEF_RadioNoise_SoundShader_500
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 1.1;
	...
	class DEF_RadioNoise_SoundShader_400
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 1.4;
	...
	class DEF_RadioNoise_SoundShader_300
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 1.65;
	...
	class DEF_RadioNoise_SoundShader_200
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 1.9;
	...
	class DEF_RadioNoise_SoundShader_100
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 2.0;
	...
	class DEF_RadioNoise_SoundShader_50
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 2.5;
	...
	class DEF_RadioNoise_SoundShader_25
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 2.25;
	...
	class DEF_RadioNoise_SoundShader_10
	{
		samples[] = {{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_1", 1},{"DynamicEventFramework\def_structures\data\sounds\environment\ambient\radio_noise_2", 1}};
		range = 5;
		volume = 3.0;
