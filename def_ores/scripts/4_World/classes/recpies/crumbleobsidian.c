class CrumbleObsidian extends RecipeBase
{
	override void Init()
	{
		m_Name = "#STR_CrumbleObsidian";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Obsidian_Nugget_DEF");				// you can insert multiple ingredients this way
		...
		//RESULTS
		//result1
		AddResult("Obsidian_Shard_DEF");							// add results here
