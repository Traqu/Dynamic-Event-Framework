class ObsidianCraftNails extends RecipeBase
{
	override void Init()
	{
		m_Name = "#STR_ObsidianCraftNails";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Obsidian_Shard_DEF");				// you can insert multiple ingredients this way
